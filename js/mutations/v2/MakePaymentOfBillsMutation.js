...
export default class MakePaymentOfBillsMutation extends Relay.Mutation {
  static fragments = {
    payment: () => Relay.QL`
  ...
  getMutation() {
    return Relay.QL`mutation{makePaymentOfBills}`;
  }
  getFatQuery() {
    return Relay.QL`
      fragment on MakePaymentOfBillsPayload {
        paymentEdge,
        changedBillsIds,
        viewer,
        payee{
