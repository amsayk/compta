...
import LineEditor from './ExpenseLineEditor';
...
@DropTarget(ItemTypes.EXPENSE, expenseTarget, connect => ({
  connectDropTarget: connect.dropTarget()
}))
@DragSource(ItemTypes.EXPENSE, expenseSource, (connect, monitor) => ({
...
export default class extends React.Component {
  ...
  static displayName = 'ExpenseAccountItems';
  ...
  render() {
    ...
    const bodyWidth = clamp(width - 60, 1220, screen.width - 60 - (openBills ? 226 : 0));
