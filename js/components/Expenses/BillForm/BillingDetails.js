...
export default class extends React.Component {
  ...
  render() {
    ...
    const {styles, formKey, fields: { mailingAddress, terms, date, dueDate, paymentRef: refNo, pristine, }} = this.props;
            ...
            <div className='row' style={{}}>
                          ...
                          case 5: // Custom
                            ...
                            (function(){
                              ...
                              self.context.store.dispatch(
                                change('bill', formKey, 'terms', terms),
                              );
                          ...
                          default:
                            ...
                            (function(){
                              ...
                              self.context.store.dispatch(batchActions([
                                change('bill', formKey, 'terms', terms),
                                change('bill', formKey, 'date', normalizeMoment(dt).format()),
                                change('bill', formKey, 'dueDate', normalizeMoment(dt).add(getTermsNumberOfDays(terms), 'days').format()),
                              ]));
              ...
              <div className='col-sm-1' style={{ width: 200, }}>
                ...
                <fieldset className='form-group'>
                  ...
                  <label styleName='subsection12TitleText' htmlFor='date'>{intl.formatMessage(messages['BillDate'])}</label>
                        ...
                        switch(getFieldValue(this.props.fields.terms)){
                          case 'Custom':
                            ...
                            (function(){
                              ...
                              self.context.store.dispatch(batchActions([
                                change('bill', formKey, 'date', normalizeMoment(moment(value)).format()),
                                change('bill', formKey, 'terms', getTermsOfDays(Math.abs(date.diff(dueDate, 'days')))),
                              ]));
                          ...
                          default:
                            ...
                            (function(){
                              ...
                              self.context.store.dispatch(batchActions([
                                change('bill', formKey, 'date', normalizeMoment(dt).format()),
                                change('bill', formKey, 'dueDate', normalizeMoment(dt).add(getTermsNumberOfDays(termsValue), 'days').format()),
                              ]));
                      ...
                      onChange={value => {
                        ...
                        //   default:
                            ...
                            (function(){
                              ...
                              self.context.store.dispatch(batchActions([
                                change('bill', formKey, 'dueDate', normalizeMoment(moment(value)).format()),
                                change('bill', formKey, 'terms', getTermsOfDays(Math.abs(date.diff(dueDate, 'days')))),
                              ]));
