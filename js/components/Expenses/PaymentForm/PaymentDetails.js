            ...
            <div className='row'>
                  ...
                  <div className=''>
                    ...
                    <Combobox
                      ...
                      onChange={value => {
                        ...
                        //   return;
                        // }
                        creditToAccountCode.onChange(value.code);
                      }}
                      data={this.props.depositsAccounts}
                      placeholder={intl.formatMessage(messages['accountPlaceholder'])}
                      value={creditToAccountCodeValue}
                      textField='name'
                      valueField='code'
                      className={classnames('no-new', {
                        'has-error': !pristine && creditToAccountCode.invalid,
                      })}
                      // disabled
                      // groupBy={ person => person.name.length }
                      // groupComponent={GroupByLength}
              ...
              <div className='col-sm-2 last-col' style={{textAlign: 'right'}}>
                ...
                <fieldset className={classnames('form-group', {'has-danger': !pristine && amountReceived.invalid,})} style={{ float: 'right', }}>
                  ...
                  <label style={{display: 'block'}} styleName='subsection12TitleText' htmlFor='amountReceived'>Montant</label>
