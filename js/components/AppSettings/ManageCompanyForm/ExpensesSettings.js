...
export default class extends React.Component {
  ...
  render() {
    ...
    tableHeight += selected === 0 ? 250 : 180;
    ...
    return (
      <Table
        ...
        rowHeightGetter={rowIndex => {
          switch (rowIndex){
            case 0 : return self.state.selected === 0 ? 250 : 180;
          }
        }}
        rowsCount={rowsCount}
        ...
        <Column
          ...
          width={tableWidth}
          cell={({rowIndex, ...props}) => {
              const {View, Form} = EXPENSES_SETTINGS_COMPANY_COMPONENTS[rowIndex];
              return (
                 <Cell {...props}>
                    <div className=''>
...
const ExpensesFormSettings = function () {
  ...
  class View extends React.Component {
    ...
    render() {
      const { root: { expensesAccounts, }, } = this.props;
      const {intl, } = this.context;
      return (
        <div>
          <div styleName='tableRow'>

            <div styleName='tableCell subsection14TitleText settingName'>{intl.formatMessage(messages['ExpensesSettingsTitle'])}</div>
                  ...
                  <div onSubmit={e => {e.preventDefault();}}>
                    ...
                    <div className='form-group row'>
                      ...
                      <div className='col-sm-7' id={'preferredPaymentMethod'}>
                        ...
                        <p className='form-control-static' styleName='labelText'>{intl.formatMessage(messages[`preferredPaymentMethod_${this.props.company.expensesSettings.preferredPaymentMethod}`])}</p>
                    ...
                    <div className='form-group row'>
                      ...
                      <label htmlFor='account' styleName='alignRight' className='col-sm-5 form-control-label'>{intl.formatMessage(messages['ExpensesAccountLabel'])}</label>

                      <div className='col-sm-7' id={'account'} style={{textAlign: 'left',}}>

                        <p className='form-control-static' styleName='labelText'>{getAccountByCode(expensesAccounts, this.props.company.expensesSettings.defaultExpenseAccountCode).name}</p>
  ...
  @reduxForm({
      ...
      initialValues: {
        ...
        preferredPaymentMethod: ownProps.company.expensesSettings.preferredPaymentMethod,
        account: ownProps.company.expensesSettings.defaultExpenseAccountCode,
      },
    }),
  ...
  class Form extends React.Component {
    ...
    render() {
      ...
      const {
        ...
        invalid,
        pristine,
        updateExpensesSettings: update,
        submitting,
        saveError: {[formKey]: saveError},
        values,

        root: {expensesAccounts},
                      ...
                      <div className='form-group row'>
                        ...
                        <div className='col-sm-7' id={'account'} style={{textAlign: 'left',}}>
                          ...
                          <Combobox
                            ...
                            data={filter(expensesAccounts, ({code}) => CODES.indexOf(code) !== -1)}
                            // value={getAccountByCode(expensesAccounts, getFieldValue(account))}
...
export const EXPENSES_SETTINGS_COMPANY_COMPONENTS = [
  ExpensesFormSettings,
];
