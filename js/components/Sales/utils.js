...
export const Dates = (intl) => ([

  {
    ...
    getValue(formKey){
      return [
        change('salesFilterForm', formKey, 'from', moment().subtract(365, 'days').toDate()),
...

  {
    ...
    getValue(formKey){
      return [
        change('salesFilterForm', formKey, 'from', moment().toDate()),
        change('salesFilterForm', formKey, 'to', moment().toDate()),
      ];
    }
  },

  {
    ...
    getValue(formKey){
      return [
        change('salesFilterForm', formKey, 'from', moment().subtract(1, 'day').toDate()),
        change('salesFilterForm', formKey, 'to', moment().subtract(1, 'day').toDate()),
      ];
    }
  },

  {
    ...
    getValue(formKey){
      return [
        change('salesFilterForm', formKey, 'from', moment().startOf('isoWeek').toDate()),
        change('salesFilterForm', formKey, 'to', moment().endOf('isoWeek').toDate()),
      ];
    }
  },

  {
    ...
    getValue(formKey){
      return [
        change('salesFilterForm', formKey, 'from', moment().startOf('month').toDate()),
        change('salesFilterForm', formKey, 'to', moment().endOf('month').toDate()),
      ];
    }
  },

  {
    ...
    getValue(formKey){
      return [
        change('salesFilterForm', formKey, 'from', moment().startOf('quarter').toDate()),
        change('salesFilterForm', formKey, 'to', moment().endOf('quarter').toDate()),
      ];
    }
  },
...

  {
    ...
    getValue(formKey){
      return [
        change('salesFilterForm', formKey, 'from', moment().subtract(1, 'year').startOf('year').toDate()),
        change('salesFilterForm', formKey, 'to', moment().subtract(1, 'year').endOf('year').toDate()),
      ];
    }
  },
