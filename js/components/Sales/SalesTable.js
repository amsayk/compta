...
function getSortKey(columnKey){
  switch (columnKey) {
    ...
    case 'latestPayment': return 'dueDate'; // 'latestPaymentDate';
            ...
            <Column
             ...
             <div>{loading || function(){
               ...
               switch(obj.type){
                 ...
                 case 'Payment': return intl.formatNumber(-1 * obj.balanceDue, {format: 'MONEY'});
            ...
            {VATEnabled && <Column
             ...
             <div>{loading || function(){
               ...
               switch(obj.type){
                 case 'Invoice': return intl.formatNumber(obj.VAT, {format: 'MONEY'});
                 case 'Sale':    return intl.formatNumber(obj.VAT, {format: 'MONEY'});
                 case 'Payment': return intl.formatNumber(0, {format: 'MONEY'});
               }
             }()}</div>
             </Cell>
           )}
