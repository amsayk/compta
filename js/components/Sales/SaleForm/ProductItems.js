...
import LineEditor from './SaleLineEditor';
...
@DropTarget(ItemTypes.SALE, saleTarget, connect => ({
  connectDropTarget: connect.dropTarget()
}))
@DragSource(ItemTypes.SALE, saleSource, (connect, monitor) => ({
