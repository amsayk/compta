...
import { SALES_ACCOUNTS_CATEGORIES, DEPOSIT_ACCOUNTS_CATEGORIES, EXPENSES_ACCOUNTS_CATEGORIES, } from '../../../../data/constants';
...
class Sales extends React.Component {
  ...
  render() {
    ...
    const data = loading || stale ? [] : loadData({
      totalCount, offset, limit, sortKey, sortDir, company: { sales: company.sales, },});
      ...
      <div className={''} styleName={''}>
        ...
        <div className='content'>
          ...
          <div styleName='page'>
            ...
            minHeight: screen.height - 236 - 50 - 25 - 3,
            background: '#fff',
            position: 'absolute',
            top: 236,
            paddingBottom: 50,
...
function wrapWithC(MyComponent, props) {
  ...
  class CWrapper extends React.Component {
    ...
    _createCustomers = () => {
      ...
      //   this._c_done = true;
      //
      //     const qury = new Parse.Query(`People_${localId}`);
      //     qury.find({sessionToken: user.sessionToken}).then(results => {
...
function loadData({ totalCount, offset, limit, sortKey, sortDir, company: { sales, }, }){
