...
export default class extends Component{
  ...
  componentWillReceiveProps(nextProps){
    ...
    if(this.state.value !== nextProps.customer.notes){
      this.setState({
        value: nextProps.customer.notes,
      });
    }
  }
  shouldComponentUpdate(nextProps, nextState){
    return nextState.value !== this.state.value || this.state.editing !== nextState.editing || nextProps.customer.notes !== this.props.customer.notes;
  }
  render(){
   ...
   */
  _save = () => {
    if(this.state.value === this.props.customer.notes){
      this.setState({
        editing: false,
      });
      return;
    ...
    this.setState({
      ...
      // do save here
      Relay.Store.commitUpdate(new UpdateCustomerNotesMutation({
        ...
        onSuccess:  ({updateCustomerNotes: {customer: { id, notes, }}}) => {
          this.setState({
            status: Status.Saved,
            editing: false,
            value: notes,
