...
function getTotalCount(type, { customers, invoices, sales, payments, }){
  return (type === 'ALL' ? customers.edges.length : invoices.totalCount + sales.totalCount + payments.totalCount);
}
...
function decorateCustomer({
  ...
  return {
    ...props,
    openBalance: props.salesStatus.open.amount,
  };
}
