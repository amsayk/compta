    ...
    return (
      <Modal
        ...
        <Modal.Header closeButton>
          <h4 className="modal-title">Cultiver l'image</h4>
        </Modal.Header>

        <div className="modal-body">

          <div styleName="AvatarCropper-base">
            <Cropper
              ref={'cropper'}
...
AvatarCropper.defaultProps = { width: 400, height: 400, modalSize: "large",
                               closeButtonCopy: "Annuler", cropButtonCopy: "Couper et enregistrer"};
