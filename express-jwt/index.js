...
module.exports = function(options) {
  ...
  var _getRequestProperty = options.getUser || options.getRequestProperty;
  ...
  var middleware = function(req, res, next) {
    ...
    async.waterfall([
      ...
      if(typeof _getRequestProperty !== 'undefined'){
        _getRequestProperty.call(null, result, function(err, requestProperty){
            if(err){
              next(new UnauthorizedError('request_property_not_found', {message: 'The request property was not found.'}));
              return;
            }
            _.set(req, _requestProperty, requestProperty);
            next();
          });
      }else{
