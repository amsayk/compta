...
export const transactionType = new GraphQLObjectType({
  ...
  fields: () => ({
    ...
    //   resolve: (transaction) => transaction.get('index'),
    // },
    refNo: {
      type: GraphQLInt,
...
export const operationType = new GraphQLObjectType({
  ...
  fields: () => ({
    ...
    // transaction: {
    //   type: transactionType,
    //   resolve: (operation) => operation.get('transaction').fetch().then(obj => { obj.__type = 'Transaction'; return obj; }),
    // },
    date: {
      type: new GraphQLNonNull(GraphQLDateTime),
...
export const paymentOfBillsType = new GraphQLObjectType({
  ...
  fields: () => ({
    ...
    refNo: {
      type: new GraphQLNonNull(GraphQLString),
      resolve: (payment) => payment.get('refNo'),
    },
    creditToAccountCode: {
      type: new GraphQLNonNull(GraphQLString),
